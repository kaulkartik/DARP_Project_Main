# we are appending the anaconda dir to 
# to sytem's path path variable 
# where pyhton finds its binaries
import sys
...
with open(path+'results.txt', 'w') as f:
    for i in instance.i:
        for j in instance.j:
            for k in instance.k:
                print(i, j, k, instance.x[i,j, k].value, instance.service[i,k].value, instance.service[j,k].value, instance.ld[i,k].value, instance.t[i,j], instance.di[i], path)
...
with open(path+'allresults.txt', 'w') as f:
    for i in instance.i:
        for j in instance.j:
            for k in instance.k:
                print(i, j, k, instance.x[i,j, k].value, instance.service[i,k].value, instance.ld[i,k].value, instance.t[i,j], instance.di[i], path)
